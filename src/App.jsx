...
export function App () {
    ...
    return (
        <>
            ...
            <main className="content m-0 flex flex-row justify-center align-top gap-20 ">
                {/* <input type="text" onChange={(e) => setSearchPicture(e.target.value)} /> */}
                {loading? <h1>Loading...</h1> : null}
                    <section className="contentartist modify__width my-15 text-left self-start grow-0">
